    ...
    <section class="cabinet">
        <div class="wrapper cabinet__wrap flex">
            ...
            <div class="cabinet__right">
                <div class="cabinet__right-title">Создать новость</div>
                                ...
                                <div class="start-company__box">
                                    <div class="start-company__label flex">
                                        ...
                                        <div class="start-company__block">
                                            <input type="text" value="{{ old('title') }}" name="title" class="start-company__field field" placeholder="Максимум 200 символов" required>
                                        </div>
                                    </div>
                                    <div class="start-company__label flex wysiwyg">
                                        ...
                                        <div class="start-company__block" style="width: 940px">
                                            <textarea name="text" id="description" class="start-company__field field" required>{{ old('text') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="start-company__bottom">
                                    <button class="start-company__btn btn">Создать новость</button>
                                </div>
                            </div>
                        </form>
                    </div>
