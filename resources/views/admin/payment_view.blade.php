                ...
                <div id="page-wrapper">
                    ...
                    @if($payment->reward)
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            @if($payment->reward->digital_downloads)


                                <tr>
                                    <th>@lang('app.downloads')</th>
                                    <td>



                                        @php
                                            $reward_media = get_media($payment->reward->digital_downloads);
                                        @endphp
                                        @if($reward_media)
                                            <a href="{{route('rewards_digital_downloads', $payment->reward->id)}}">
                                                <p><i class="fa fa-cloud-download"></i> {!! $reward_media->name !!} </p>
                                            </a>
