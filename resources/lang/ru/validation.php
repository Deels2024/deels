...
return [
    ...
    */
    ...
    'equals' => 'Поле :attribute должно иметь значение :mustBeOfValue',
    'max' => [
    ...
    'gte' => ['numeric' => 'Поле :attribute должно быть больше 0'],
    'in' => 'Введенное значение :attribute не подходит',
    ...
    'phone' => 'Поле :attribute должно содержать 11 цифр',
    'phone_secret' => 'Поле :attribute должно содержать 4 цифры',
    'string' => 'Поле :attribute должно быть строкой',
    'boolean' => 'Поле :attribute должно содержать true или false',
    'morph_exists' => 'Такой сущности не существует',
    'uuid' => 'Поле :attribute должно быть корректным UUID',
    'not_in' => 'Поле :attribute не может содержать указанное значение',
    'exists' => 'Поле :attribute не может содержать указанное значение',
    'confirmed' => ':attribute не соответствует подтвержденному значению',
    'ends_with' => ':attribute должен быть возе ".ru"',
    ...
    'custom' => [
        'criteria' => [
            'required' => 'Выберите критерий победителя',
        ],
    ...
    'attributes' => [
        ...
        'message' => 'Сообщение',
        'email' => 'E-Mail адрес',
        'subject' => 'E-Mail адрес',
        'password_confirmation' => 'Подтверждение пароля',
        'password' => 'Пароль',
        'username' => 'Ник',
        'goal' => 'Цель копилки',
        'agreement' => 'Политика об обработке персональных данных',
