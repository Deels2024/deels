        ...
        return response()->json([
            ...
            'data' => [
                ...
                'links' => [
                    ...
                    'battles' => route('deels.public.battles.index'),
                    'stories' => route('stories.catalog'),
                    'campaigns' => route('deels.public.campaigns.index'),
                ...
                'filters' => [
                    ...
                    'battles' => [
                        ['id' => 'active', 'title' => 'Активные', 'url' => route('deels.public.battles.index', ['type' => 'active'])],
                        ['id' => 'finished', 'title' => 'Завершённые', 'url' => route('deels.public.battles.index', ['type' => 'finished'])],
                    ],
                ],
                'sections' => [
