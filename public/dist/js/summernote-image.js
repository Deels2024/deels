	...
	$.extend($.summernote.plugins, {
		'imageAttributes': function (context) {
			...
			this.initialize = function () {
				...
				var body = '<ul style="display: none" class="nav note-nav nav-tabs note-nav-tabs">' +
				...
				body += '</ul>' +
					...
					// Tab 2
					'<div style="display: none"  class="tab-pane note-tab-pane" id="note-imageAttributes-attributes-' + i + '">' +
				...
				if (options.imageAttributes.disableUpload == false) {
// Tab 4
					body += '<div style="display: none"  class="tab-pane note-tab-pane" id="note-imageAttributes-upload-' + i + '">' +
